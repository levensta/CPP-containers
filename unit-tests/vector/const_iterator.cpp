...
void	const_iterator() {
	mkdir("./unit-tests/vector/const_iterator", 0777);
	std::cout << "Const:\t\t|";
	std::list<int>	lst;
	lst.push_back(10);
	lst.push_back(99);
	...
	/*  OPERATOR*  */
	{
		...
		print_test_iterator<int, std::list<int>::const_iterator>(std_lst, ft_lst, mode, 1, "./unit-tests/vector/const_iterator/operator*.log");

		/*Test2*/
		bool	two = (*ft_it == *std_it);
		list_push(std_lst, ft_lst, *std_it, *ft_it);
		print_test_iterator<int, std::list<int>::const_iterator>(std_lst, ft_lst, mode, 2, "./unit-tests/vector/const_iterator/operator*.log");


		bool	three = test_vector<int, std::vector<int>::const_iterator, ft::vector<int>::const_iterator>(std_vec, ft_vec);
		print_test_vector<int, std::vector<int>::const_iterator, ft::vector<int>::const_iterator>(std_vec, ft_vec, mode, 3, "./unit-tests/vector/const_iterator/operator*.log");
	...
	/*  OPERATOR++  */
	{
		...
		list_push(std_lst, ft_lst, *(std_it), *(ft_it));
		print_test_iterator<int, std::list<int>::const_iterator>(std_lst, ft_lst, mode, 3, "./unit-tests/vector/const_iterator/operator++.log");


		bool	four = test_vector<int, std::vector<int>::const_iterator, ft::vector<int>::const_iterator>(std_vec, ft_vec);
		print_test_vector<int, std::vector<int>::const_iterator, ft::vector<int>::const_iterator>(std_vec, ft_vec, mode, 4, "./unit-tests/vector/const_iterator/operator++.log");
	...
	/*  OPERATOR==  */
	{
		...
		print_test_iterator<bool, std::list<bool>::const_iterator>(std_lst, ft_lst, mode, 1, "./unit-tests/vector/const_iterator/operator==.log");
		...
		list_push<bool>(std_lst, ft_lst, std_bool, ft_bool);
		print_test_iterator<bool, std::list<bool>::const_iterator>(std_lst, ft_lst, mode, 2, "./unit-tests/vector/const_iterator/operator==.log");
	...
	/*  OPERATOR<=  */
	{
		...
		list_push<bool>(std_lst, ft_lst, std_bool, ft_bool);
		print_test_iterator<bool, std::list<bool>::const_iterator>(std_lst, ft_lst, mode, 3, "./unit-tests/vector/const_iterator/operator<=.log");
	...
	/*  OPERATOR+  */
	{
		...
		print_test_iterator<int, std::list<int>::const_iterator>(std_lst, ft_lst, mode, 4, "./unit-tests/vector/const_iterator/operator+.log");

		bool	five = test_vector<int, std::vector<int>::const_iterator, ft::vector<int>::const_iterator>(std_vec, ft_vec);
		print_test_vector<int, std::vector<int>::const_iterator, ft::vector<int>::const_iterator>(std_vec, ft_vec, mode, 5, "./unit-tests/vector/const_iterator/operator+.log");
